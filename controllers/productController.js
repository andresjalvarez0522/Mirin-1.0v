...
export const getSingleProductController = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Solo un producto obtenido",
      product,
    });
  } catch (error) {
    console.log(error);
...
export const updateProductController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      error,
      message: "Error en actualizacion de producto",
    });
  }
};
...
export const productListController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message:
        "Lo siento, parece que ha ocurrido un error al obtener la lista de productos.",
      error,
    });
  }
};
...
export const searchProductController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error en la api de buscar producto ",
    });
  }
};
